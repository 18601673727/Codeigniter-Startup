...
class Assets {
    ...
    private static function _init_cssmin()
    {
        if (self::$minify_css and ! self::$freeze and ! self::$_cssmin_loaded)
        {
            ...
            else                      include(reduce_double_slashes(APPPATH.'/libraries/cssmin/cssmin.php'));
    ...
    private static function _init_jsmin()
    {
        if (self::$minify_js and ! self::$freeze and ! self::$_jsmin_loaded)
        {
            ...
            else                      include(reduce_double_slashes(APPPATH.'/libraries/jsmin/jsmin.php'));
    ...
    private static function _init_jspacker()
    {
        if (self::$pack_js and ! self::$freeze and ! self::$_jspacker_loaded)
        {
            ...
            else                      include(reduce_double_slashes(APPPATH.'/libraries/jspacker/jspacker.php'));
    ...
    private static function _init_less()
    {
        if ( ! self::$freeze and ! self::$_less_loaded)
        {
            ...
            else                      include(reduce_double_slashes(APPPATH.'/libraries/lessc/lessc.php'));
    ...
    private static function _init_sass()
    {
        if ( ! self::$freeze and ! self::$_sass_loaded)
        {
            ...
            else                      include(reduce_double_slashes(APPPATH.'/libraries/phpsass/SassParser.php'));
    ...
    private static function _init_coffeescript()
    {
        if ( ! self::$freeze and ! self::$_coffeescript_loaded)
        {
            ...
            else                      include(reduce_double_slashes(APPPATH.'/libraries/coffeescript/coffeescript.php'));
